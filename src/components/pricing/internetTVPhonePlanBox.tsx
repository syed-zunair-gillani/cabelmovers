...
function InternetTVPhonePlanBox({ Plans, pro_phone }: any) {
    return (
        <div className=" w-full lg:max-w-[1200px] mx-auto h-auto">
            <div className="w-full h-auto shadow-xl border rounded-t-md rounded-b-md flex md:flex-col flex-row items-stretch">
                <div className='md:w-full min-w-fit grid md:grid-cols-6 grid-cols-1 bg-[#215690] '>
...
export default InternetTVPhonePlanBox
